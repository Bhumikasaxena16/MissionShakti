...
import com.upicon.app.BasicActivities.Registration;
...
public class UserList extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                assert result != null;
                userAdapter.getFilter().filter(result.get(0));
    ...
    private void getUserList() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, BaseURL.USER_LIST,
    ...
    private void setResponse(String response) {
        ...
        if (!response.isEmpty()){
            ...
            List<User> items = gson.fromJson(response, listType);
            usersList.clear();

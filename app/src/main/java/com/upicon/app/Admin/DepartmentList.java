...
import com.upicon.app.Adapters.DepartmentAdapter;
...
public class DepartmentList extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                assert result != null;
                departmentAdapter.getFilter().filter(result.get(0));
    ...
    private void recyclerView() {
        ...
        departmentAdapter = new DepartmentAdapter(DepartmentList.this, departmentList);
    ...
    private void getUserList() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, BaseURL.DEPARTMENT_LIST,
    ...
    private void setResponse(String response) {
        ...
        if (!response.isEmpty()){
            ...
            List<Department> items = gson.fromJson(response, listType);

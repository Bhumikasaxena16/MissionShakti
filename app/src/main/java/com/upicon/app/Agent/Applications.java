...
import com.upicon.app.Adapters.ApplicationAdapter;
...
public class Applications extends AppCompatActivity {
    ...
    private void toolBar() {
        ...
        toolbar.setTitle(intent.getStringExtra("status")+" Applications");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                assert result != null;
                applicationAdapter.getFilter().filter(result.get(0));
    ...
    private void searchView() {
        ...
        autoCompleteTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                applicationAdapter.getFilter().filter(s);
            }
    ...
    private void recyclerView() {
        ...
        applicationAdapter = new ApplicationAdapter(Applications.this, applicationList);
    ...
    private void getUserList() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, BaseURL.APPLICATION_LIST,
    ...
    private void setResponse(String response) {
        ...
        if (!response.isEmpty()){
            ...
            List<Application> items = gson.fromJson(response, listType);
            applicationList.clear();
            applicationList.addAll(items);

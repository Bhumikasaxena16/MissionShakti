...
import com.upicon.app.Adapters.AuditAdapter;
...
public class SurveyList extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                assert result != null;
                auditAdapter.getFilter().filter(result.get(0));
    ...
    private void searchView() {
        ...
        autoCompleteTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                auditAdapter.getFilter().filter(s);
            }
    ...
    private void recyclerView() {
        ...
        auditAdapter = new AuditAdapter(SurveyList.this, auditList);
    ...
    private void getUserList() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, BaseURL.AUDIT_LIST,
    ...
    private void setResponse(String response) {
        ...
        if (!response.isEmpty()){
            Gson gson = new Gson();
            Type listType = new TypeToken<List<Audit>>(){}.getType();
            List<Audit> items = gson.fromJson(response, listType);
            auditList.clear();
            auditList.addAll(items);
